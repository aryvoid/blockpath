...
export type Enchant = {
  ...
  max: number;
  desc: string;
  /** Higher = more expensive on anvil */
  weight: number;
  conflicts?: string[];
};
...
const ALL: Record<string, Enchant> = {
  ...
  smite: { id: "smite", name: "Smite", max: 5, desc: "Extra damage to undead (zombies, skeletons…).", weight: 1, conflicts: ["sharpness", "bane_of_arthropods"] },
  bane_of_arthropods: { id: "bane_of_arthropods", name: "Bane of Arthropods", max: 5, desc: "Extra damage to spiders, silverfish, bees.", weight: 1, conflicts: ["sharpness", "smite"] },
  ...
  channeling: { id: "channeling", name: "Channeling", max: 1, desc: "Thunder hits on thunderstorm.", weight: 4, conflicts: ["riptide"] },
  ...
  density: { id: "density", name: "Density", max: 5, desc: "Mace: more damage from fall height.", weight: 1, conflicts: ["breach"] },
  breach: { id: "breach", name: "Breach", max: 4, desc: "Mace: reduces armor effectiveness.", weight: 2, conflicts: ["density"] },
  ...
  binding_curse: { id: "binding_curse", name: "Curse of Binding", max: 1, desc: "Cannot remove armor until death.", weight: 4 },
};
...
/** Suggest book merge order: expensive first, then pair-wise tip */
